...
class profile:
    ...
    def _parse_kineto_results(self, result: _ProfilerResult):
        ...
        function_events = []
        # prepare the no_link list to separate host events from with framework-assigned
        # correlation IDs from other events whose correlation IDs were assigned
        # concurrently but non-unique relative to the framework.
        function_events_no_link = []
        # Assume that id as key in corr_map should only stand for CPU Framework events
        ...
        function_events = function_events.expend(function_events_no_link)
